...
Plans:
- [x] 11-01-PLAN.md — Docker dev infrastructure: Dockerfile.dev, docker-compose.yml, .env.example, .gitignore updates
- [x] 11-02-PLAN.md — OLLAMA_BASE_URL env var support in settings.ts with TDD tests
