...
const GREEN_VALUES = new Set([
  'strong', 'compelling', 'sharp', 'high',
  'scroll-stopping', 'crystal-clear', 'must-use', 'hero-quote',
  'memorable', 'tight', 'multi-season', 'emotion-led',
  'dominant', 'unified', 'on-message',
]);

const SECONDARY_VALUES = new Set([
  'adequate', 'serviceable', 'moderate',
  'mostly-clear', 'well-paced', 'limited-series',
  'balanced', 'mostly-consistent', 'partially-aligned', 'recurring',
]);

const DESTRUCTIVE_VALUES = new Set([
  'weak', 'needs-work', 'underdeveloped', 'limited', 'niche',
  'muddled', 'unclear', 'slow', 'uneven', 'questionable',
  'mixed-signals', 'contradictory', 'off-message', 'needs-coaching', 'flat',
]);
